package br.com.jefferson.efd.contribuicoes.util;//Util
...
public class Util {
    ...
    public static String getHash(File arquivo) {
        ...
        try {
            ...
            throw new LeitorException("Unable to process file for MD5", e);
        }
    }
    ...
    public static boolean verificarArquivoSped(File fileTxt) {
        ...
        try {
            ...
            throw new LeitorException("Não foi possivel fazer verificação do arquivo SPED", ex);
        }
