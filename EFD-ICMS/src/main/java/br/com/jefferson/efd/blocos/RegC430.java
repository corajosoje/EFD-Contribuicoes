...
@NamedQueries({
    ...
    @NamedQuery(name = "RegC430.findByHash", query = "SELECT r FROM RegC430 r WHERE r.hash = :hash"),
    ...
    @NamedQuery(name = "RegC430.findByVlUnitBcIcmsStEstoqueConv", query = "SELECT r FROM RegC430 r WHERE r.vlUnitBcIcmsStEstoqueConv = :vlUnitBcIcmsStEstoqueConv"),
...
public class RegC430 implements Serializable {
    ...
    public RegC430(Long id) {
        this.id = id;
    }

    public RegC430(Long id, long idPai, long linha, String hash) {
        this.id = id;
        this.idPai = idPai;
        this.linha = linha;
        this.hash = hash;
