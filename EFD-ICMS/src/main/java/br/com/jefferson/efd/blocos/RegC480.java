...
@NamedQueries({
    ...
    @NamedQuery(name = "RegC480.findByHash", query = "SELECT r FROM RegC480 r WHERE r.hash = :hash"),
    ...
    @NamedQuery(name = "RegC480.findByVlUnitBcIcmsStEstoqueConv", query = "SELECT r FROM RegC480 r WHERE r.vlUnitBcIcmsStEstoqueConv = :vlUnitBcIcmsStEstoqueConv"),
...
public class RegC480 implements Serializable {
    ...
    public RegC480(Long id, long idPai, long linha, String hash) {
        this.id = id;
        this.idPai = idPai;
        this.linha = linha;
        this.hash = hash;
