...
@NamedQueries({
    ...
    @NamedQuery(name = "RegD510.findByHash", query = "SELECT r FROM RegD510 r WHERE r.hash = :hash"),
...
public class RegD510 implements Serializable {
    ...
    public RegD510(Long id) {
        this.id = id;
    }

    public RegD510(Long id, long idPai, long linha, long hash) {
        this.id = id;
        this.idPai = idPai;
        this.linha = linha;
        this.hash = hash;
