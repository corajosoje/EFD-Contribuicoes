...
@NamedQueries({
    ...
    @NamedQuery(name = "RegC115.findByHash", query = "SELECT r FROM RegC115 r WHERE r.hash = :hash"),
...
public class RegC115 implements Serializable {
    ...
    public RegC115(Long id) {
        this.id = id;
    }

    public RegC115(Long id, long idPai, long linha, long hash) {
        this.id = id;
        this.idPai = idPai;
        this.linha = linha;
        this.hash = hash;
